...
const ProperySelect = (property) => {
    ...
    return <div className="property-wrapper" onClick={select}>
    <div className="property-select">
       <div className={`property-select__value + ${(phoneState.phone[property.field] === property.value) ? "property-select__value_selected": "property-select__value_not-selected"}`}>
       {property.title}
       </div>
    </div>
    </div>
