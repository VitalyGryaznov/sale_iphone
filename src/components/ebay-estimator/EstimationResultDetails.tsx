  ...
  return (
    <div className="results_container">
      {props.isLoading ? (
            ...
            <h1>
        Es dauert ungefähr <span className="results_highlited_part">{props.days} Tage</span>, um es bei eBay für <span className="results_highlited_part">{props.price}€</span> zu
        verkaufen*
      </h1>
      </div>
          )}
